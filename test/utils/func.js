...
async function placeOrder(driver,data) {
    try {
        ...
        const childrenInput = await driver.wait(until.elementLocated(By.id("children-count-input")), 5000);
        ...
        // Click submit button
        let confirmButton = await driver.wait(until.elementLocated(By.xpath("//*[@id='booking-form']/button")), 5000);
